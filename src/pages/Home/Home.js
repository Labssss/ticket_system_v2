...
const Home = () => {
    const {isLogged, role, user} = useContext(CustomContext);
    ...
    return (
        <>
            ...
            <div className="text-center bg-gray-50 text-gray-800 py-20 px-6">
                <h1 className="text-5xl font-bold mt-0 mb-6">Желаете обратиться с службу поддержки?</h1>
            ...
            <>
                <div className="text-center bg-gray-50 text-gray-800 py-20 px-6">
                    <h1 className="text-5xl font-bold mt-0 mb-6">Панель администратора</h1>
                </div>
                <AdminPanel/>
            </>
            : 
